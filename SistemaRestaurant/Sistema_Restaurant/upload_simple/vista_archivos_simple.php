...
if($files=="")
{
	...
	{
		$files=$reg->imagen_plato;
		$id=$reg->id_imagen_plato;
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <button class="btn btn-danger delete" onclick="EliminarArchivo('<?=$token;?>','<?=$nombre_archivo;?>','<? echo $id;?>')"> <i class="glyphicon glyphicon-trash"></i> <span>Eliminar</span> </button>
