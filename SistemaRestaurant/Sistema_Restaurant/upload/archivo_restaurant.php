...
<div class="col-sm-12 col-md-12 col-lg-12 container"> <br>
  ...
  <input name="archivo" id="archivo" type="hidden" value="1">
        ...
        <td>
            <span class="preview">
                {% if (file.thumbnailUrl) { %}
                    <a href="sistema_restaurant/+{%=file.url%}" target="_blank" title="{%=file.name%}" ><img src="sistema_restaurant/+{%=file.thumbnailUrl%}" class="FotoUpload"></a>
                {% } %}
            </span>
        </td>
        <td>
...
<a href="sistema_restaurant/+{%=file.url%}" target="_blank" title="sistema_restaurant/+{%=file.name%}">{%=file.name%}</a>
...
<script src="sistema_restaurant/upload/js/main2.js"></script>
