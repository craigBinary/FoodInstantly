  ...
  <div class="container">
    <nav class="navbar navbar-default">
      ...
      <div class="navbar-header w3l_logo">
        ...
        <h1><a href="index.php">Food Instantly<span>Hazla corta</span></a></h1>
      </div>
      ...
      <div class="cart cart box_1">
        <form action="#" method="post" class="last">
          ...
          <button class="w3view-cart" type="submit" name="submit" value=""><i class="fa fa-edit" aria-hidden="true"></i></button>
        </form>
      </div>
    </nav>
  </div>
